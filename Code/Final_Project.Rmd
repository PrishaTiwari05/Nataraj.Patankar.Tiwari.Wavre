...
ggplot(Filtered_Combined_Data, aes(x = Total_EV, y = Number_of_Stations, color = Source)) +
  ...
  labs(
    title = "EV Stations vs Yearly EV Registrations (2016–2026)",
    x = "Yearly EV Registrations",
    y = "Yearly Number of EV Charging Station Installations",
    color = "Data Type"
  ) +
  theme_minimal(base_size = 14) + 
  theme(
