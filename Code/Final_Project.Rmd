...
##Motivation
Understanding the relationship between EV sales trends and fuel station installations is critical for infrastructure planning, policy development, and investment strategies. As EV adoption increases, the demand for traditional gas stations is expected to decline, while the need for EV charging infrastructure grows. Analyzing these trends can provide insights into how the U.S. should strategically adapt it’s refueling infrastructure to support the clean energy transition. Analyzing population and income will help us make decisions on whether we should site EV charging stations based on these parameters.
